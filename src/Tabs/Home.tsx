    ...
    <div className='w-full flex-1 space-y-6 mb-10 h-full'>
      ...
      <header className="w-full px-6 py-4 bg-white border-b border-gray-200 flex justify-between items-center">
        ...
        <div className="flex gap-3">
          ...
          <button className="px-4 py-2 text-[14px] font-medium rounded-lg bg-blue-800 text-white hover:bg-green-800 transition-all duration-200 flex items-center gap-2 shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-blue-800 to-blue-900 rounded-lg p-5 text-white">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center backdrop-blur-sm">
                <Users className="w-6 h-6" />
              </div>
              <div>
                <p className="text-[12px] text-blue-100">Registered Students</p>
            ...
            <div className="grid grid-cols-2 gap-3 pt-3 border-t border-white/20">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-[10px] text-blue-200">Active</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-[10px] text-blue-200">Inactive</p>
                  <p className="text-[14px] font-semibold">650</p>
                </div>
              </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-5">
            <h3 className="text-[14px] font-semibold text-gray-900 mb-3">Upload Student List</h3>
